  ...
  return (
    <div className="font-Luciole_Regular flex flex-col items-center mt-[50px] lg:flex-row lg:justify-around lg:flex-wrap gap-4 m-4">
      {products && products.map((product) => (
        <div key={product.id} className="flex flex-col items-center bg-gradient-to-b from-firstStepGradient via-secondStepGradient to-thirdStepGradient p-[2px] rounded-[20px] w-[250px] h-[350px] px-[30px] py-[20px] mt-6 relative">
          {product.is_sale && <Image src="/Images/promo.png" alt="promotion" width={1000} height={1000} className="absolute right-[-33px] top-[-35px] w-[100px] z-10" />}
